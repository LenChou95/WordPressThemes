...
$.extend($[iphoneStyle].prototype, {
  ...
  wrapCheckboxWithDivs: function() {
    this.$elem.wrap('<div class="' + this.containerClass + '" style="width: 67px;" />');
    this.container = this.$elem.parent();
    
    this.offLabel  = $('<label style="width: 26px" class="'+ this.labelOffClass +'">' +
                         '<span>'+ this.uncheckedLabel +'</span>' +
                       '</label>').appendTo(this.container);
    this.offSpan   = this.offLabel.children('span');
    
    this.onLabel   = $('<label style="width: 26px" class="'+ this.labelOnClass +'">' +
